...
public class ReverseList {
	...
	public void test1() {
		...
		Assert.assertTrue(Arrays.equals(new int[] {5,4,3,2,1}, reverseListUsingQueue(nums)));
	}
	...
	public void test2() {
		...
		Assert.assertTrue(Arrays.equals(new int[] {1,1,1,1}, reverseListUsingQueue(nums)));
	}
	...
	public void test3() {
		...
		Assert.assertTrue(Arrays.equals(new int[] {}, reverseListUsingQueue(nums)));
	}
	
	/*
	 * Pseudo code - Linear
	 * Create an output array of size length
	 * Traverse through the array from last to 0
	 ...
	 * Traverse through the array
	 * 		Poll the last element in the queue and store in the array from index 0
	 * Return the array
	 * 
	 */
