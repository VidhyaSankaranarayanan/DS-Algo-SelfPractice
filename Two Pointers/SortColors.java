...
class SortColors {
	...
	public void test1() {
		...
		assertArrayEquals(new int[] {0,0,1,1,2,2}, sortColorsUsing3Pointers(input));
	}
	
	@Test
	public void test2() {
		int[] input = {2,0,1};
		assertArrayEquals(new int[] {0,1,2}, sortColorsUsing3Pointers(input));
	}
	
	@Test
	public void test3() {
		int[] input = {0};
		assertArrayEquals(new int[] {0}, sortColorsUsing3Pointers(input));
	}
	
	@Test
	public void test4() {
		int[] input = {};
		assertArrayEquals(new int[] {}, sortColorsUsing3Pointers(input));
	}
	...
	private int[] sortColorsUsing3Pointers(int[] nums) {
		if(nums.length < 2)
			return nums;
